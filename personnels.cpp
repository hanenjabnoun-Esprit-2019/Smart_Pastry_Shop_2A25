...
bool personnels::controleEmail(QString test)
{
...
bool personnels::controlenum(int test)
{
...
bool personnels::controlenumm(int test)
{
    QString tel= QString::number(test);
    if(tel!="")
        return  true;
...
bool personnels::controleVide(QString test)
{
    if(test!="")
        return  true;
    return false;
...
void personnels::on_pushButton_91_clicked()
{
    //ajouter personnel
...
void personnels::on_pushButton_92_clicked()
{     ui->tableView_11->setModel(tmppersonnel.afficher());
...
void personnels::on_pushButton_93_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}

void personnels::on_pushButton_98_clicked()
{
    ui->stackedWidget->setCurrentIndex(1);
}

void personnels::on_pushButton_99_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}

void personnels::on_pushButton_94_clicked()
{
    //modifier personnel
    int cin = ui->lineEdit_31->text().toInt();
    QString nom= ui->lineEdit_32->text();
...
void personnels::on_tableView_11_activated(const QModelIndex &index)
{
...
void personnels::on_pushButton_95_clicked()
{
    //supprimer personnel
    int cin = ui->lineEdit_31->text().toInt();
...
void personnels::on_pushButton_107_clicked()
{
    //ajouter departement
...
void personnels::on_tableView_12_activated(const QModelIndex &index)
{
...
void personnels::on_pushButton_146_clicked()
{
...
void personnels::on_pushButton_145_clicked()
{
...
void personnels::on_pushButton_97_clicked()
{
...
void personnels::on_comboBox_31_activated(const QString &arg1)
{
...
void personnels::on_pushButton_106_clicked()
{
...
void personnels::on_comboBox_33_activated(const QString &arg1)
{
...
void personnels::on_pushButton_147_clicked()
{
     ui->stackedWidget->setCurrentIndex(0);
}

int personnels::on_pushButton_96_clicked()
{
...
void personnels::on_pushButton_100_clicked()
{
...
void personnels::on_pushButton_102_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}

void personnels::on_pushButton_148_clicked()
{
     ui->stackedWidget->setCurrentIndex(0);
}

int personnels::on_pushButton_103_clicked()
{
...
void personnels::on_try_5_activated(const QString &arg1)
{
    QString cin=ui->try_5->currentText();
    connection conn;
...
void personnels::on_pushButton_108_clicked()
{
    ui->try_4->setModel(tmppersonnel.afficher_email_rep());
    ui->stackedWidget->setCurrentIndex(4);
}

void personnels::on_pushButton_101_clicked()
{
     ui->stackedWidget->setCurrentIndex(6);
}
