...
maintenance::maintenance(int reference,int id_materiel ,QString nom_reparateur, QDate derniere_reparation, QDate prochaine_visite, QString description )
...
QString maintenance::getdescription(){return description;}
 ...
 bool maintenance::ajouter (){
     ...
     QString reference_string=QString::number(reference);
           ...
           query.prepare("INSERT INTO Maintenance (reference, id_materiel, nom_reparateur, derniere_reparation, prochaine_visite, description) "
                                      "VALUES (:reference, :id_materiel, :nom_reparateur, :derniere_reparation, :prochaine_visite, :description)");
 ...
 bool maintenance::modifiermaintenance( int reference, int id_materiel, QString nom_reparateur, QDate derniere_reparation, QDate prochaine_visite, QString description){

     QSqlQuery query;
     query.prepare("UPDATE materiel set reference=:reference,id_materiel=:id_materiel,nom=:nom,prix=:prix,quantite=:quantite,date_achat=:date_achat,date_garantie=:date_garantie,lieux_achat=:lieux_achat WHERE id_materiel=:id_materiel");
...
/*QSqlQueryModel* maintenance::trier_reference()
     {  QSqlQueryModel * model=new QSqlQueryModel();
             ...
             model->setHeaderData(1, Qt::Horizontal, QObject::tr("Nom du reparateur"));
             model->setHeaderData(1, Qt::Horizontal, QObject::tr("Derniere reparation"));
