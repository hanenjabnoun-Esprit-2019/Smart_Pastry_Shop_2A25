...
void gestion_client::on_pushButton_5_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}

void gestion_client::on_pushButton_11_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}
...
//gestion client
void gestion_client::on_pb_ajouter_clicked()
{
...
void gestion_client::on_modifclient_clicked()
{
...
void gestion_client::on_table_client_clicked(const QModelIndex &index)
{
...
void gestion_client::on_tri_c_clicked()
{
  ui->table_client->setModel(c.trier_cin());
}

void gestion_client::on_tri_n_clicked()
{
     ui->table_client->setModel(c.trier_nom());
}

void gestion_client::on_exp_c_clicked()
{
...
void gestion_client::on_recherche_clicked()
{
...
void gestion_client::on_afficher_normal_clicked()
{
     ui->table_client->setModel(c.afficher());
}
...
//gestion carte fidelite




void gestion_client::on_pb_ajouter_c_clicked()
{
...
void gestion_client::on_pb_supp_c_clicked()
{
    carte f1;
...
void gestion_client::on_modifcarte_clicked()
{
...
void gestion_client::on_table_carte_clicked(const QModelIndex &index)
{
...
void gestion_client::on_tri_r_clicked()
{
   ui->table_carte->setModel(f.trier_ref());
}

void gestion_client::on_tri_ci_clicked()
{
    ui->table_carte->setModel(f.trier_cinclient());
}

void gestion_client::on_exp_2_clicked()
{
...
void gestion_client::on_rech_2_clicked()
{
...
void gestion_client::on_afficher_clicked()
{
      ui->table_carte->setModel(f.afficher());
}
