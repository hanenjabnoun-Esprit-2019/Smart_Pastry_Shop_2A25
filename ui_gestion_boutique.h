...
public:
    ...
    void setupUi(QDialog *gestion_boutique)
    {
        ...
        stackedWidget->setGeometry(QRect(-10, 30, 1311, 541));
        page = new QWidget();
...
""));
        ...
        lineEdit_18->setStyleSheet(QString::fromUtf8("border: 0px solid rgb(100, 100,100);; \n"
"border-bottom-width: 2px;\n"
"border-radius: px;\n"
"background-color: rgba(255, 255, 255, 0);\n"
"color: rgb(255, 255, 255);"));
...
""));
        ...
        home2->setGeometry(QRect(1040, 490, 91, 23));
...
""));
    ...
    void retranslateUi(QDialog *gestion_boutique)
    {
        ...
        pushButton_4->setText(QCoreApplication::translate("gestion_boutique", "PushButton", nullptr));
