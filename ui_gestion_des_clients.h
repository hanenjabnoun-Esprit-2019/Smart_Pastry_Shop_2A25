...
"color: rgb(255, 255, 255);"));
        ...
        label_18->setStyleSheet(QStringLiteral("font: 24pt \"MS Shell Dlg 2\";"));
...
""));
    ...
    void retranslateUi(QMainWindow *gestion_des_clients)
    {
        ...
        label->setText(QApplication::translate("gestion_des_clients", "Gestion clients et carte-fid\303\251lit\303\251", Q_NULLPTR));
        label_3->setText(QString());
        label_4->setText(QString());
        label_19->setText(QString());
        pushButton_4->setText(QApplication::translate("gestion_des_clients", "Deconnexion", Q_NULLPTR));
