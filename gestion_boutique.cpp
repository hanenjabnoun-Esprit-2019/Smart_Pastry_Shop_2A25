...
gestion_boutique::~gestion_boutique()
{
    delete ui;
}

void gestion_boutique::on_pushButton_2_clicked()
{
     ui->stackedWidget->setCurrentIndex(1);
}

void gestion_boutique::on_pushButton_3_clicked()
{
    ui->stackedWidget->setCurrentIndex(2);

}

void gestion_boutique::on_ajouter_commande_clicked()
{
...
void gestion_boutique::on_supprimer_boutique_clicked()
{
    boutique b1;
...
void gestion_boutique::on_bar_ajoutC_clicked()
{
    ui->stackedWidget_2->setCurrentIndex(0);
}

void gestion_boutique::on_bar_modifC_clicked()
{
     ui->stackedWidget_2->setCurrentIndex(1);
}

void gestion_boutique::on_bar_affichC_clicked()
{
    ui->stackedWidget_2->setCurrentIndex(2);
}


void gestion_boutique::on_bar_suppC_clicked()
{
     ui->stackedWidget_2->setCurrentIndex(3);
}

void gestion_boutique::on_bar_ajoutB_clicked()
{
     ui->stackedWidget_3->setCurrentIndex(0);
}

void gestion_boutique::on_bar_modifB_clicked()
{
    ui->stackedWidget_3->setCurrentIndex(1);
}

void gestion_boutique::on_bar_affichB_clicked()
{
...
void gestion_boutique::on_bar_suppB_clicked()
{
    ui->stackedWidget_3->setCurrentIndex(2);
}

void gestion_boutique::on_home2_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);

}

void gestion_boutique::on_home1_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);

}

void gestion_boutique::on_modifier_boutique_clicked()
{
...
void gestion_boutique::on_modifier_commande_clicked()
{
...
void gestion_boutique::on_tri_boutique_clicked()
{
...
void gestion_boutique::on_pushButton_22_clicked()
{
...
void gestion_boutique::on_lineEdit_17_textChanged(const QString &arg1)
{
...
void gestion_boutique::sendMail()
{
    ...
    smtp->sendMail("omrani.mohamedaziz@esprit.tn", ui->lineEdit_email->text() , "hoptimal","you are welcome");
}
...
void gestion_boutique::on_sendmail_clicked()
{
    sendMail();
}
